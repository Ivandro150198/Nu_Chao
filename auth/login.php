...
if (current_user()) {
    $u = current_user();
    if ($u['tipo'] === 'ADMIN') redirect('/No_chao/admin/');
    if ($u['tipo'] === 'ENTREGADOR') redirect('/No_chao/entregador/');
...
<section class="auth-wrap">
  <div class="auth-card">
    ...
    <?php if (google_configurado()): ?>
      <a class="btn-google" href="/No_chao/auth/google_auth.php?modo=login">
    ...
    <p class="help">Não tem conta? <a class="js-open-register" href="/No_chao/auth/registar.php">Registar</a></p>
  </div>
</section>
